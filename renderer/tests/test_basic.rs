...
fn render_node() {
    ...
    let n2 = Node::builder(NodeId::new(2)).width(LengthOrExpr::points(70.0)).height(LengthOrExpr::points(20.0)).bg_color(c1).build();
    let n3 = Node::builder(NodeId::new(3)).width(LengthOrExpr::points(70.0)).height(LengthOrExpr::points(20.0)).bg_color(c2).build();
